...
public class BerClassWriter {
    ...
    private void writeSimpleDecodeFunction(String param) throws IOException {
        ...
        write("public void test(ByteArrayInputStream bis){\n" +
                "\t\tInputStream is = bis;\n" +
                "\t\ttry {\n" +
                "\t\t\tdecode(is);\n" +
                "\t\t} catch (IOException e) {\n" +
...
//    write("sb.append(\"}\");");
    ...
    private void writeClassHeader(String typeName, AsnModule module) throws IOException {
        ...
        write("import java.io.ByteArrayInputStream;");
        write("import java.io.ByteArrayInputStream;");
    ...
    private void write(String line) throws IOException {
        ...
        for (int i = 0; i < indentNum; i++) {
            Compiler.GeneratedClassSource+="\t";
            out.write("\t");
        }
        Compiler.GeneratedClassSource+=line + "\n";
        out.write(line + "\n");
